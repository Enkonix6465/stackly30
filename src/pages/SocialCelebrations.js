    ...
    <div className={darkMode ? "home-page dark-mode" : "home-page light-mode"}>
      ...
      <div className="hero-container-corporate">
        ...
        <div className="hero-content-corporate">
          <h1 className="hero-tagline-corporate">“Celebrate, Connect, Cherish</h1>
      ...
      <section className="corporate-events-section">
        <div className="corporate-events-wrapper">
          ...
          <div className="corporate-events-content">
            <h2>Social Celebrations</h2>
            <p style={{ textAlign: "justify" }}>
              Every celebration brings people closer—it's not just about the lights, music, or food, but the bonds woven in laughter and conversation. Whether it’s a birthday soirée, a community gathering, or a casual get-together, it's those heartfelt connections and shared stories that turn moments into memories. From the joyful hugs to the spontaneous toasts, social celebrations remind us
            </p>
            <ul>
      ...
      <section className="client-spotlight-section">
        <div className="client-spotlight-wrapper">
          <div className="spotlight-content">
            <h2 className="spotlight-heading">Client Spotlight: Innovatech’s Annual Social Celebration</h2>
